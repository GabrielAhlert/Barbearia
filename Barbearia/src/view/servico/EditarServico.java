...
public class EditarServico extends javax.swing.JFrame {
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        ServicoDAO sdao = new ServicoDAO();
        Servico servico = (Servico) jComboBox1.getSelectedItem(); 
        
        if(check()){
            
            s.setCodigo(servico.getCodigo());
            s.setNome(servico.getNome());
            s.setPreco(Double.parseDouble(jFValor.getText().toString()));
            
            boolean resultado = sdao.updateServico(s);
            if(resultado){
             JOptionPane.showMessageDialog(this, "Update efetuado Suceso");
             this.dispose();
            }else{
             ...
             JOptionPane.showMessageDialog(this, "Update não efetuado, dados invalidos","ERRO",2);
